...
class CustomerNewBusBookingPredefinedScreen extends StatefulWidget {
  const CustomerNewBusBookingPredefinedScreen({super.key});

  @override
  _CustomerNewBusBookingPredefinedScreenState createState() =>
      _CustomerNewBusBookingPredefinedScreenState();
}

class _CustomerNewBusBookingPredefinedScreenState
    extends State<CustomerNewBusBookingPredefinedScreen> {
    ...
    return Scaffold(
                ...
                children: [
                  CircleAvatar(
                    ...
                    child: Icon(
                      ...
                      color: Colors
                          .white, // Set the color of the icon (white for contrast)
                    ),
                  ),
                            ...
                            children: [
                              ...
                              const CircleAvatar(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    color: Colors
                                        .white, // Text color to contrast with the teal background
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      margin: const EdgeInsets.only(
                        bottom: 80,
                        right: 20,
                      ), // Adjust for floating button position
                      decoration: BoxDecoration(
                        color: Colors.redAccent.shade200,
                        borderRadius: BorderRadius.circular(12),
                        boxShadow: [
                      ...
                      width:
                          ...
                          0.6, // Adjust width as per requirement
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
      ...
      floatingActionButton: currentUser == null
          ...
          : FloatingActionButton(
              ...
              child: Icon(
                _isContainerVisible ? Icons.close : Icons.question_answer,
                color: Colors.white,
              ),
            ),
    );
