...
import 'cust_bus_cancl_details_faqs.dart';


class CustBusCanclFaqs extends StatelessWidget {
  const CustBusCanclFaqs({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CustBusCanclDetailsFaqs(faqId: doc.id),
                        ),
                      );
                    },
                  ),
