...
class CustBusCanclDetailsFaqs extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const CustBusCanclDetailsFaqs({super.key, required this.faqId});

  @override
  _CustBusCanclDetailsFaqsState createState() => _CustBusCanclDetailsFaqsState();
}

class _CustBusCanclDetailsFaqsState extends State<CustBusCanclDetailsFaqs> {
