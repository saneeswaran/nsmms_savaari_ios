...
class CustViewPaymentAndRefundFaqs extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const CustViewPaymentAndRefundFaqs({super.key, required this.faqId});

  @override
  _CustViewPaymentAndRefundFaqsState createState() => _CustViewPaymentAndRefundFaqsState();
}

class _CustViewPaymentAndRefundFaqsState extends State<CustViewPaymentAndRefundFaqs> {
