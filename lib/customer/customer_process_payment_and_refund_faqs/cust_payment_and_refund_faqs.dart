...
import 'cust_view_payment_and_refund_faqs.dart';



class CustPaymentAndRefundFaqs extends StatelessWidget {
  const CustPaymentAndRefundFaqs({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CustViewPaymentAndRefundFaqs(faqId: doc.id),
                        ),
                      );
                    },
                  ),
