...
class CustomerViewWalletFaqs extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const CustomerViewWalletFaqs({super.key, required this.faqId});

  @override
  _CustomerViewWalletFaqsState createState() => _CustomerViewWalletFaqsState();
}

class _CustomerViewWalletFaqsState extends State<CustomerViewWalletFaqs> {
