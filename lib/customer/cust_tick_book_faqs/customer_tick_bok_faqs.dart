...
import 'package:namma_savaari/customer/cust_tick_book_faqs/ticket_book_faq_details.dart';
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => FAQDetailPage(faqId: doc.id),
                        ),
                      );
                    },
                  ),
