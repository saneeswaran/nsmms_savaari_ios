...
class CustomerViewTripRewardsFaqs extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const CustomerViewTripRewardsFaqs({super.key, required this.faqId});

  @override
  _CustomerViewTripRewardsFaqsState createState() => _CustomerViewTripRewardsFaqsState();
}

class _CustomerViewTripRewardsFaqsState extends State<CustomerViewTripRewardsFaqs> {
