...
import 'customer_view_trip_rewards_faqs.dart';


class CustomerTripRewardsFaqs extends StatelessWidget {
  const CustomerTripRewardsFaqs({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CustomerViewTripRewardsFaqs(faqId: doc.id),
                        ),
                      );
                    },
                  ),
