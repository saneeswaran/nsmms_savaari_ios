...
class _BusListPageState extends State<BusListPage> {
  ...
  Future<void> _fetchBusResults() async {
    ...
    final Map<String, dynamic> requestBody = {
      ...
      "source_code": widget.sourceCityId,
      "destination_city": widget.destinationCity,
      "destination_code": widget.destinationCityId,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        final data = jsonDecode(response.body);
        log("Response Data: $data"); // Debugging output to check the structure
        setState(() {
          _busResults = data['Result']?['BusResults'] ?? [];
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    DateFormat('MMM dd').format(
                      DateTime.parse(widget.journeyDate),
                ...
                Padding(
                  padding: const EdgeInsets.only(
                    top: 4.0,
                    right: 19,
                  ), // Add some space between the container and the day text
                  child: Text(
              ...
              itemBuilder: (context, index) {
                ...
                return InkWell(
                  onTap: () {
                    ...
                    log("Selected Bus ResultIndex: ${bus['ResultIndex']}");
                    log(widget.sourceCity); // Use widget.sourceCity directly
                    log(
                      widget.destinationCity,
                    ); // Use widget.sourceCity directly
                    log(widget.journeyDate); // Use widget.sourceCity directly
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              const SizedBox(
                                width: 8,
                              ), // Space between Arrival and divider
                              Container(
                              ...
                              const SizedBox(
                                width: 8,
                              ), // Space between divider and Departure Time
                              Text(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(
                                        width: 4,
                                      ), // Space between cross mark and OfferedPrice
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(
                                width: 8,
                              ), // Small space between the elements
                              Container(
                                height: 2, // Height of the divider
                          ...
                          const SizedBox(
                            height: 8,
                          ), // Add space between TravelName and Time Difference
                          Text(
                            "${bus['BusType'] ?? "N/A"}",
                            style: const TextStyle(
                              fontSize: 12,
