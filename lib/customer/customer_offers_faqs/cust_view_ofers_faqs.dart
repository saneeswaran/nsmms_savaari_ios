...
class CustOfersDetailsFaqs extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const CustOfersDetailsFaqs({super.key, required this.faqId});

  @override
  _CustOfersDetailsFaqsState createState() => _CustOfersDetailsFaqsState();
}

class _CustOfersDetailsFaqsState extends State<CustOfersDetailsFaqs> {
