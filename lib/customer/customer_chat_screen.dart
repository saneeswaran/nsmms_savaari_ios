...
import '../main.dart'; // Import intl for date formatting
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(messageData['text'],style: const TextStyle(color: Colors.black),), // Message text
                              const SizedBox(height: 4), // Space between text and time
                              Text(
