...
class CustTikRescheCanclDetailsFaqs extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const CustTikRescheCanclDetailsFaqs({super.key, required this.faqId});

  @override
  _CustTikRescheCanclDetailsFaqsState createState() => _CustTikRescheCanclDetailsFaqsState();
}

class _CustTikRescheCanclDetailsFaqsState extends State<CustTikRescheCanclDetailsFaqs> {
