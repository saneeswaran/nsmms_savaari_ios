...
import 'cust_tik_resche_cancl_details_faqs.dart';

class CustTikRescheCanclFaqs extends StatelessWidget {
  const CustTikRescheCanclFaqs({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CustTikRescheCanclDetailsFaqs(faqId: doc.id),
                        ),
                      );
                    },
                  ),
