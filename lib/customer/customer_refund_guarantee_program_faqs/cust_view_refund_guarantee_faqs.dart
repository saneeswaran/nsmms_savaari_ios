...
class CustomerViewRefundGuaranteeFaqs extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const CustomerViewRefundGuaranteeFaqs({super.key, required this.faqId});

  @override
  _CustomerViewRefundGuaranteeFaqsState createState() => _CustomerViewRefundGuaranteeFaqsState();
}

class _CustomerViewRefundGuaranteeFaqsState extends State<CustomerViewRefundGuaranteeFaqs> {
