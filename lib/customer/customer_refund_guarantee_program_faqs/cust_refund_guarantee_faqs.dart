...
import 'cust_view_refund_guarantee_faqs.dart';





class CustomerRefundGuaranteeFaqs extends StatelessWidget {
  const CustomerRefundGuaranteeFaqs({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CustomerViewRefundGuaranteeFaqs(faqId: doc.id),
                        ),
                      );
                    },
                  ),
